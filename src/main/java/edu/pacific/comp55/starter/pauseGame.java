...
public class pauseGame extends GraphicsPane{
	private Level program;
	private GObject toDrag;

	private GRect pauseRect;
	private GImage pauseTitle;
	...
	public pauseGame(Level app) {
		super();
		program = app;
		pauseRect = new GRect(0, 120, 1980, 400);
		pauseRect.setFilled(true);
		pauseRect.setFillColor(Color.BLACK);
		pauseTitle = new GImage("pauseTitle.png", 480, 140);
		pauseTitle.setSize(284.58, 75 );
		...
		quit = new GButton("QUIT GAME", 532, 380, 200, 50);
		quit.setFillColor(Color.GRAY);
		quit.setLineColor(Color.WHITE);
		
	}

	@Override
	public void showContents() {
		program.add(pauseRect);
		program.add(pauseTitle);
	...
	public void hideContents() {
		program.remove(pauseRect);
		program.remove(pauseTitle);
	...
	public void mousePressed(MouseEvent e) {
		...
		if (obj == quit) quit.setFillColor(Color.DARK_GRAY);
	}
